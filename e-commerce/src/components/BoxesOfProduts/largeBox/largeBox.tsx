...
export default function largeBox(props: { alt: string, image: string, texto: string, backGround: string}) {
  ...
  return (
    <div className={`largeBox-container ${ props.backGround}`}>
      <span className="largeBox-container-box1">
        <img src={props.image} alt={props.alt} className="largeBox-container-box1-image"/>
      </span>
